...
(define cs151-core-version "S7.2")
(provide cs151-core-version)

(: cs151-core-date : String)
(define cs151-core-date "January 14, 2022")
...
(: cs151-core-pair : (All (A B) (-> A B (Pairof A B))))
(define (cs151-core-pair a b) (cons a b))
(provide (rename-out [cs151-core-pair make-pair]))
...
;; we are using this for the project
